                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                      <TextField
                        ...
                        helperText="Minimum 8 characters (uppercase, lowercase, and number required)"
                    ...
                    <Grid item xs={12}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2, mt: 2 }}>
                        <Divider sx={{ flex: 1, borderColor: '#4facfe', borderWidth: 1 }} />
                        <Typography 
                          variant="h6" 
                          sx={{ 
                            fontWeight: 700, 
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        onChange={handleChange}
                        helperText="e.g., Father, Mother, Spouse, Friend"
                      />
                    </Grid>
